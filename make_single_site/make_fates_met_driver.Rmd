...
knit: (function(input_file, encoding) {
  out_dir = file.path(dirname(input_file),"docs_make_fates_met_driver");
  dummy   = dir.create(out_dir,showWarnings=FALSE,recursive=TRUE);
  rmarkdown::render(input_file,encoding=encoding,output_file=file.path(out_dir,"index.html"))})
references:
- id: bolton1980mwr
