...
case_info = tidyr::tribble( ~idx, ~name                                     , ~model     , ~desc                                    , ~tstampa     , ~tstampz
                          ...
                          ,    1, "S0001_ParacouNewPhen_CLM_FATES"          , "CLM-FATES", "Paracou: Simple Allocation (EG+HD)"     , NA_character_, NA_character_
                          ,    2, "S0002_TanguroNewPhen_CLM_FATES"          , "CLM-FATES", "Tanguro: Simple Allocation (EG+HD)"     , NA_character_, NA_character_
                          ,    3, "S0003_PetrolinaNewPhen_CLM_FATES"        , "CLM-FATES", "Petrolina: Simple Allocation (EG+HD)"   , NA_character_, NA_character_
                          ,    4, "S0004_ParacouEvergreen_CLM_FATES"        , "CLM-FATES", "Paracou: Simple Allocation (EG Only)"   , NA_character_, NA_character_
                          ,    5, "S0005_TanguroEvergreen_CLM_FATES"        , "CLM-FATES", "Tanguro: Simple Allocation (EG Only)"   , NA_character_, NA_character_
                          ,    6, "S0006_PetrolinaEvergreen_CLM_FATES"      , "CLM-FATES", "Petrolina: Simple Allocation (EG Only)" , NA_character_, NA_character_
                          ,    7, "S0007_ParacouOldCAllocEGDD_CLM_FATES"    , "CLM-FATES", "Paracou: Default Allocation (EG+HD)"    , NA_character_, NA_character_
                          ,    8, "S0008_TanguroOldCAllocEGDD_CLM_FATES"    , "CLM-FATES", "Tanguro: Default Allocation (EG+HD)"    , NA_character_, NA_character_
                          ,    9, "S0009_PetrolinaOldCAllocEGDD_CLM_FATES"  , "CLM-FATES", "Petrolina: Default Allocation (EG+HD)"  , NA_character_, NA_character_
                          ,   10, "S0010_ParacouOldCAllocEGOnly_CLM_FATES"  , "CLM-FATES", "Paracou: Default Allocation (EG Only)"  , NA_character_, NA_character_
                          ,   11, "S0011_TanguroOldCAllocEGOnly_CLM_FATES"  , "CLM-FATES", "Tanguro: Default Allocation (EG Only)"  , NA_character_, NA_character_
                          ,   12, "S0012_PetrolinaOldCAllocEGOnly_CLM_FATES", "CLM-FATES", "Petrolina: Default Allocation (EG Only)", NA_character_, NA_character_
                          ,   13, "S0013_ParacouOldThresh_CLM_FATES"        , "CLM-FATES", "Paracou: SWC Threshold (EG+HD)"         , NA_character_, NA_character_
                          ,   14, "S0014_TanguroOldThresh_CLM_FATES"        , "CLM-FATES", "Tanguro: SWC Threshold (EG+HD)"         , NA_character_, NA_character_
                          ,   15, "S0015_PetrolinaOldThresh_CLM_FATES"      , "CLM-FATES", "Petrolina: SWC Threshold (EG+HD)"       , NA_character_, NA_character_
                          )#end tribble
