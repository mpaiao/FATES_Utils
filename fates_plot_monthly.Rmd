...
case_desc  = "Paracou Evergreen-Deciduous (CLM-FATES)" # Simulation description
tstampa    = NA_character_ # "01/01/2004"         # First time (MM/DD/YYYY)
tstampz    = NA_character_ # "12/01/2019"         # Last time (MM/DD/YYYY)
...
pftinfo[[n]] = list( id     = 2
                   , key    = "pft02"
                   , short  = "HyDd"
                   , desc   = "Hydro-deciduous Tropical Tree"
                   , colour = "#F8766D"
                   )#end list
```
